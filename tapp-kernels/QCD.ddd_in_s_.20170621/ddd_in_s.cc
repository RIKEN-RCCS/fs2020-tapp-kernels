...
extern "C"{
  ...
  //---------------------------------------------------------------------------------------- mult D in bulk
  void ddd_in_s_noprl(scs_t* __restrict__ out, const scs_t* __restrict__ in, const int* DEO, int iam) {
...
//    }//omp parallel
  ...
  void ddd_in_s_(scs_t* __restrict__ out, const scs_t* __restrict__ in, const int* DEO, int iam) {
	  ddd_in_s_noprl(out, in, DEO, iam);
  }
#ifdef __cplusplus
}
#endif
